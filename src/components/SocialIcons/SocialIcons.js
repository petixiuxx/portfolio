...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/thanhNt16" style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/thanh-nguyen-9a238a16a/" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/thanh.nguyentrung13" style={ { color: colorPrimary } }><i className="fab fa-facebook"></i></a>
